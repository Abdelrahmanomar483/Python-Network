...
with open(r"C:\Abdelrahman\courses\python\Python_for_Network_Engineers-main\03_Cisco_Config_Parser_Regex\02_show_run_output.txt",'r') as file:
	output = file.read()
	...
	print(f"here's user names {username_iter}")
	user_list =[]
